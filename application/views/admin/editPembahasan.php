    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-10 shadow">
                ...
                <form action="<?= base_url('MaterialAndTask/updateDiscussion') ?>" method="POST" enctype="multipart/form-data">
                    <div class="row m-2">
                        ...
                        <div class="col-md-7 mb-3">
                            ...
                            <a href="<?= base_url('assets/docfile/') . $materi['file'] ?>" class="d-block"><?= $materi['file'] ?></a>
                        </div>
