...
<html lang="en" data-bs-theme="auto">
    ...
    <body class="d-flex align-items-center py-4 bg-body-tertiary">
        <main class="form-signin m-auto" style="width: 100%; max-width: 450px">
            <form action="<?= base_url('Login_admin/register') ?>" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating my-1">
                            <input type="no_telp" class="form-control" id="no_telp" name="no_telp" placeholder="name@example.com" required>
