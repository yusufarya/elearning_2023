...
<div class="container-fluid mt-5" style="min-height: 100vh;">
    <br> 
    <h4 class="p-3 shadow-sm rounded"><?= $data['title'] .' - '. $detailMapel[0]['pelajaran'] ?></h4>
    <a href="<?= base_url('home') ?>" class="text-decoration-none me-2 text-secondary" style="font-family: monospace; float: right;">< Kembali ke halaman awal</a><br>
    <hr class="mx-3">
                    ...
                    <div class="card p-2" style="width: 100%;">
                        ...
                        <div class="row justify-content-around">
                            ...
                            <div class="col me-2 text-end">
                                <a href="<?= base_url('daftar_tugas/').$mapel['id'] ?>" class="btn btn-sm btn-outline-info" style="font-size: 15px; "> 
                                Selengkapnya..
                                </a> - 
                                <a href="<?= base_url('daftar_tugas/').$mapel['id'] ?>" class="btn btn-sm btn-outline-info" style="font-size: 15px;"> 
